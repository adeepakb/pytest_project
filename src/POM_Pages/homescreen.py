...
class HomeScreen():
    ...
    home_screen_user_name=(By.ID,"com.byjus.thelearningapp:id/header_title_text")
    greeting_text=(By.ID,"com.byjus.thelearningapp:id/header_greeting_text")
    analytics_icon=(By.ID,"com.byjus.thelearningapp:id/home_analytics")
    back_btn=(By.ID,"com.byjus.thelearningapp:id/roundedNavButton")
    ...
    back_to_top_arrow=(By.ID,"com.byjus.thelearningapp:id/backToTopClick")
    back_arrow = (By.ID,"com.byjus.thelearningapp:id/backNav")
    
    badge_icon=(By.ID,"com.byjus.thelearningapp:id/cvUserLevel")
    badge_screen=(By.XPATH,"//android.widget.TextView[@text='My Badges' and @resource-id='com.byjus.thelearningapp:id/header_title_text']")
    badge_level=(By.ID,"com.byjus.thelearningapp:id/tvLevelNumber")
    badge_name=(By.ID,"com.byjus.thelearningapp:id/tvLevelName")
    
    subject_grid_view=(By.ID,"com.byjus.thelearningapp:id/home_subject_gridLayout")
    subject_names=(By.XPATH,"//android.widget.LinearLayout[@resource-id='com.byjus.thelearningapp:id/home_subject_view_layout']/descendant::android.widget.TextView[@resource-id='com.byjus.thelearningapp:id/home_subject_name_txtvw']")
    
    
    recently_learned_card_header=(By.ID,"com.byjus.thelearningapp:id/home_card_section_title")
    recently_learned_card_text=(By.ID,"com.byjus.thelearningapp:id/home_card_title_text")
    forward_arrow_in_recent_learned_card=(By.ID,"com.byjus.thelearningapp:id/home_card_section_right_arrow_button")
    recent_learned_screen=(By.XPATH,"//android.widget.TextView[@text='Recently Learned']")
    recently_learned_card=(By.ID,"com.byjus.thelearningapp:id/home_card_Linear_layout")
    recently_learned_card_image=(By.XPATH,"//android.widget.LinearLayout[@resource-id='com.byjus.thelearningapp:id/home_card_Linear_layout']/android.widget.LinearLayout[@index=0]")
    
    resume_journey_text=(By.XPATH,"//android.widget.TextView[@text='Resume Journey']")
    resume_journey_card=(By.XPATH,"//android.widget.TextView[@text='Resume Journey']/following-sibling::android.widget.FrameLayout/descendant::android.widget.LinearLayout[@resource-id='com.byjus.thelearningapp:id/home_card_Linear_layout']")
    
    
    top_one_recomeandation=(By.ID,"com.byjus.thelearningapp:id/tvTopRecommendationTitle")
    top_pics_text=(By.ID,"com.byjus.thelearningapp:id/tvRecommendationTitle")
    top_pics_card=(By.ID,"com.byjus.thelearningapp:id/llTopRecommendation")
    top_pics_recomandation_bar=(By.ID,"com.byjus.thelearningapp:id/rvRecommendation")
    cards_inside_recomandation_bar=(By.XPATH,"//androidx.recyclerview.widget.RecyclerView[@resource-id='com.byjus.thelearningapp:id/rvRecommendation']/descendant::android.widget.TextView[@resource-id='com.byjus.thelearningapp:id/tvName']")
    ele_for_scroll=(By.XPATH,"//androidx.recyclerview.widget.RecyclerView[@resource-id='com.byjus.thelearningapp:id/rvRecommendation']/descendant::android.widget.LinearLayout[3]") 
    ...
    quizzo_hero_image=(By.XPATH,"//android.widget.TextView[@text='Quizzo']/following-sibling::android.widget.FrameLayout/descendant::android.widget.LinearLayout[@resource-id='com.byjus.thelearningapp:id/home_card_Linear_layout']/descendant::android.widget.LinearLayout[@index=0][1]")
    ...
    quizzo_forward_arrow=(By.XPATH,"//android.widget.TextView[@text='Quizzo']/following-sibling::android.widget.FrameLayout/descendant::android.widget.ImageView[@resource-id='com.byjus.thelearningapp:id/home_card_section_right_arrow_button']")
    quizzo_screen=(By.ID,"com.byjus.thelearningapp:id/btnQuizzoChallenge")
    
    byjus_corner_text=(By.ID,"com.byjus.thelearningapp:id/home_discover_txtvw_title")
    byjus_corner_card_text=(By.XPATH,"//android.widget.TextView[@resource-id='com.byjus.thelearningapp:id/home_discover_nametxtv'][1]")
    byjus_corner_forward_arrow=(By.ID,"com.byjus.thelearningapp:id/button_show_all")
    byjus_corner_see_all_text=(By.XPATH,"//android.widget.TextView[@text='See All']")
    byjus_corner_cards_bar=(By.ID,"com.byjus.thelearningapp:id/home_discover_lstvw")
    byjus_corner_screen_title=(By.ID,"com.byjus.thelearningapp:id/home_discover_lstvw")
    byjus_corner_screen_description=(By.ID,"com.byjus.thelearningapp:id/discover_detail_webview")
    byjus_corner_screen_other_content=(By.ID,"com.byjus.thelearningapp:id/discover_detail_more_from_channel_txtvw")
    byjus_corner_bar_first_ele=(By.XPATH,"//androidx.recyclerview.widget.RecyclerView[@resource-id='com.byjus.thelearningapp:id/home_discover_lstvw']/descendant::android.widget.FrameLayout[2]")
    byjus_corner_first_article=(By.XPATH,"//androidx.recyclerview.widget.RecyclerView[@resource-id='com.byjus.thelearningapp:id/home_discover_lstvw']/descendant::android.widget.FrameLayout[1]")
    byjus_corner_screen=(By.ID,"com.byjus.thelearningapp:id/toolbar_title")
    byjus_corner_text_video_icon=(By.XPATH,"//android.widget.RelativeLayout/descendant::android.widget.ImageView[@resource-id='com.byjus.thelearningapp:id/home_discover_icon_imgvw']")
    
    share_the_app_text=(By.ID,"com.byjus.thelearningapp:id/home_card_section_title")
    share_the_app_card=(By.XPATH,"//android.widget.TextView[@text='Share the app']/following-sibling::android.widget.FrameLayout/descendant::android.widget.LinearLayout[@resource-id='com.byjus.thelearningapp:id/home_card_Linear_layout']")
    share_the_app_hero_image=(By.XPATH,"//android.widget.TextView[@text='Share the app']/following-sibling::android.widget.FrameLayout/descendant::android.widget.LinearLayout[@resource-id='com.byjus.thelearningapp:id/home_card_Linear_layout']/descendant::android.widget.LinearLayout[@index=0][1]")
    share_with_friends_txt=(By.ID,"com.byjus.thelearningapp:id/home_card_title_text")
    share_the_app_subtitle_txt=(By.XPATH,"//android.widget.TextView[@text='Share the app']/following-sibling::android.widget.FrameLayout/descendant::android.widget.TextView[@resource-id='com.byjus.thelearningapp:id/home_card_sub_title_text']")
    share_the_app_forward_arrow=(By.XPATH,"//android.widget.TextView[@text='Share the app']/following-sibling::android.widget.FrameLayout/descendant::android.widget.ImageView[@resource-id='com.byjus.thelearningapp:id/home_card_section_right_arrow_button']")
    share_pop_up_txt=(By.ID,"com.byjus.thelearningapp:id/shareTitle")
    share_pop_up_share_list=(By.ID,"com.byjus.thelearningapp:id/share_list")
    share_pop_up_list_item=(By.XPATH,"//androidx.recyclerview.widget.RecyclerView[@resource-id='com.byjus.thelearningapp:id/share_list']/descendant::android.widget.LinearLayout[1]")
    ...
    hamburger_menu_button=(By.ID,"com.byjus.thelearningapp:id/roundedNavButton")
    user_image_in_home_drawer=(By.ID,"com.byjus.thelearningapp:id/home_drawer_imgvw_profile")
    home_drawer=(By.ID,"com.byjus.thelearningapp:id/home_drawer_header_view")
    home_drawer_profile_name=(By.ID,"com.byjus.thelearningapp:id/home_drawer_txtvw_profile_name")
    home_drawer_grade=(By.ID,"com.byjus.thelearningapp:id/home_drawer_txtvw_course")
    home_drawer_forwar_arrow=(By.ID,"com.byjus.thelearningapp:id/home_drawer_imgvw_arrow_right")
    grade_selection_drop_dwn=(By.ID,"com.byjus.thelearningapp:id/tvGrade")
    total_subjects=(By.XPATH,"//android.widget.GridLayout[@resource-id='com.byjus.thelearningapp:id/home_subject_gridLayout']/descendant::android.widget.RelativeLayout")
    
    goggle_icon=(By.ID,"com.byjus.thelearningapp:id/homeCameraX")
    camera_permission_agree_btn=(By.ID,"com.byjus.thelearningapp:id/primaryAction")
    camera_permission_no_thanks_btn=(By.ID,"com.byjus.thelearningapp:id/secondaryAction")
    ...
    camera_permission_pop_up=(By.ID,"com.byjus.thelearningapp:id/dialog_layout")
    
    request_home_dmo_btn=(By.ID,"com.byjus.thelearningapp:id/home_drawer_txtvw_home_demo")
...
#             set_connection_type(browser, "DATA_ONLY")
    ...
    def verify_byjus_corner_card(self, browser): 
        try:
            check_byjus_corner_card = browser.find_element_by_android_uiautomator("new UiScrollable(new UiSelector().resourceId(\"com.byjus.thelearningapp:id/home_scroll_view\")).setAsVerticalList().scrollIntoView("
    ...
    def verify_byjus_corner_seeall_forward_icon(self,browser):
        try:
            check_seeall = browser.find_element_by_android_uiautomator("new UiScrollable(new UiSelector().resourceId(\"com.byjus.thelearningapp:id/home_discover_lstvw\")).setAsHorizontalList().scrollIntoView("
...
#                     logging.info(i.text)
    ...
    def get_subject_count(self,browser):
        try:
            CommonMethods.wait_for_locator(browser, self.total_subjects, 10)
...
#             grade_xpath=(By.XPATH,"//android.widget.TextView[@text='6th grade']")
            ...
            CommonMethods.wait_for_locator(browser, self.home_drawer_grade, 3)
            CommonMethods.elementClick(browser, self.home_drawer_grade)
            CommonMethods.wait_for_locator(browser, self.grade_selection_drop_dwn, 3)
...
#             CommonMethods.click_on_device_back_btn(browser)
    ...
    def odd_sub_left_alligned(self,browser):
        ...
        if (sub_in_6th_grade) % 2 !=0:
            last_subject=(By.XPATH,"//android.widget.GridLayout[@resource-id='com.byjus.thelearningapp:id/home_subject_gridLayout']/descendant::android.widget.RelativeLayout[@index=sub_in_6th_grade]")   
