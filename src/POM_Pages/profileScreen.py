...
#     enrolled_courses = (By.XPATH,"//android.widget.RelativeLayout/descendant::android.widget.ImageView[@resource-id='com.byjus.thelearningapp.premium:id/course_enrolled_view']")
    ...
    enrolled_courses = (By.XPATH,"//android.widget.RelativeLayout/descendant::android.widget.ImageView[@resource-id='com.byjus.thelearningapp.premium:id/course_enrolled_view']/preceding-sibling::android.widget.TextView")
    
    my_badges_see_all_icon = (By.ID,"com.byjus.thelearningapp.premium:id/badges_show_all_lyt")
    three_badges = (By.XPATH,"//androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout[@resource-id='com.byjus.thelearningapp.premium:id/llBadgeContainerLyt']")
    ...
    gender_list_elements = (By.XPATH,"//android.widget.ListView/descendant::android.widget.TextView[not(@text = 'Gender')]")
...
#             course_list[2]
    ...
    def selected_course_with_radio_btn(self,browser):
        try:
            ...
            perticular_course_radio_btn =  (By.XPATH,"//android.widget.RelativeLayout/descendant::android.widget.TextView[@text='"+text+"']/preceding-sibling::android.widget.RadioButton") 
    ...
    def check_course_radio_btn_enabled(self,browser):
        try:
            perticular_course_radio_btn =  (By.XPATH,"//android.widget.RelativeLayout/descendant::android.widget.TextView[@text='8th Grade']/preceding-sibling::android.widget.RadioButton") 
            radio_btn = CommonMethods.getElement(browser, perticular_course_radio_btn)
            check = radio_btn.is_enabled()
            if check == True:
