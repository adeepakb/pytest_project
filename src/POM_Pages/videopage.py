...
f = open("C:/EclipseWorkspaces/csse120/premium_app/src/Test_data/featureFileName.txt","r")
...
class VideoPage():
    ...
    practice_continue_btn = (By.ID,"com.byjus.thelearningapp:id/primaryAction")
    practice_submit_btn = (By.ID,"com.byjus.thelearningapp:id/action_morph_btn")
    practice_2nd_answer = (By.XPATH,"//android.widget.ListView//android.view.View[@index=1]//android.view.View[@index=1]")
    practice_start_practice_btn = (By.ID,"com.byjus.thelearningapp:id/tvStartPractice")
    ...
    profile_name = (By.ID,"com.byjus.thelearningapp:id/header_title_text")
    ...
    profile_name_hamburger = (By.ID,"com.byjus.thelearningapp:id/home_drawer_imgvw_arrow_right")
    ...
    Btn_test = (By.ID, "com.byjus.thelearningapp:id/chapter_list_item_test_txtvw")
    Btn_practice = (By.ID, "com.byjus.thelearningapp:id/practice_mode_bottom_txtvw")
    ...
    first_videoLnk_xpath = (By.XPATH, "//android.widget.LinearLayout[@resource-id='com.byjus.thelearningapp:id/chapter_view_group' and @index=1]/androidx.recyclerview.widget.RecyclerView[@resource-id='com.byjus.thelearningapp:id/chapter_videos_lstvw']/android.widget.LinearLayout[@resource-id='com.byjus.thelearningapp:id/chapter_video_list_cardview' and @index = 0]")
    video_frame_id = (By.ID, "com.byjus.thelearningapp:id/exo_subtitles")
    chapter_videoLnk_elements = (By.XPATH,"//android.widget.ImageView[@resource-id = 'com.byjus.thelearningapp:id/chapter_video_thumbnail_imgvw']")
    tab_chapter_videoLnk_elements = (By.ID,"com.byjus.thelearningapp:id/chapter_view_group")
    video_pause_btn_id = (By.ID, "com.byjus.thelearningapp:id/exo_pause")
    video_play_btn = (By.ID, "com.byjus.thelearningapp:id/exo_play")
    video_play_next_btn = (By.ID,"com.byjus.thelearningapp:id/ivNext")
    video_play_previous_btn = (By.ID,"com.byjus.thelearningapp:id/ivPrevious")
    videoPlayingNow_xpath = (By.XPATH, "//androidx.recyclerview.widget.RecyclerView[@resource-id='com.byjus.thelearningapp:id/video_list_view']/android.widget.LinearLayout[@index=0]//android.widget.TextView[@resource-id='com.byjus.thelearningapp:id/chapter_video_subitem_name_txtv']")
    ...
    progressTime_id = (By.ID, "com.byjus.thelearningapp:id/exo_position")
    remaingTime_id = (By.ID, "com.byjus.thelearningapp:id/exo_duration")
    ten_sec_fwd_btn_id = (By.ID, "com.byjus.thelearningapp:id/exo_ffwd")
    ten_sec_bkwd_btn_id = (By.ID, "com.byjus.thelearningapp:id/exo_rew")
    byjusAppPackage = "com.byjus.thelearningapp"
    skipBtn_id = (By.ID, "com.byjus.thelearningapp:id/buttonSkip")
    video1stLink_xpath = (By.XPATH,"//androidx.recyclerview.widget.RecyclerView[@resource-id='com.byjus.thelearningapp:id/video_list_view']/android.widget.LinearLayout[@index=0]")
    ...
    video_time_remaining = (By.ID,"com.byjus.thelearningapp:id/chapter_video_subitem_name_txtv")
    ...
    video_comming_soon_dialog_popup = (By.XPATH, "//android.widget.TextView[@text='Coming Soon' and @resource-id = 'com.byjus.thelearningapp:id/dialog_title']")
    chapter_name_text = (By.XPATH,"//androidx.recyclerview.widget.RecyclerView[@resource-id='com.byjus.thelearningapp:id/chapter_list_view']//android.widget.TextView[@resource-id='com.byjus.thelearningapp:id/header_title_text']")

#    subject page
    subject_title_id = (By.ID,"com.byjus.thelearningapp:id/title")
    
#     Video Player Screen Locators
    screen_orientation_id = (By.ID,"com.byjus.thelearningapp:id/orientation_toggle")
    video_backBtn_id = (By.ID,"com.byjus.thelearningapp:id/back")
    videoSpeed_up_dwnIcon_id = (By.ID,"com.byjus.thelearningapp:id/playback_speed")
    video_subtitileIcon_id = (By.ID,"com.byjus.thelearningapp:id/subtitle_tracks")
    video_mutipleAudioTracks_id = (By.ID,"com.byjus.thelearningapp:id/audio_tracks")
    video_settingIcon_id = (By.ID,"com.byjus.thelearningapp:id/settings")
    video_progressBar_id = (By.ID,"com.byjus.thelearningapp:id/exo_progress")
    videoPauseBtn_id2 = "com.byjus.thelearningapp:id/exo_pause"
    video_1stLnk = (By.XPATH,"//androidx.recyclerview.widget.RecyclerView[@resource-id='com.byjus.thelearningapp:id/video_list_view']/android.widget.LinearLayout[@index=0]//android.widget.TextView[@resource-id='com.byjus.thelearningapp:id/chapter_video_subitem_name_txtv']")
    video_video_frame_id = (By.ID,"com.byjus.thelearningapp:id/videoViewLayout")
    video_auto_play_buttom_sheet = (By.ID, "com.byjus.thelearningapp:id/design_bottom_sheet")
    video_name_list_elements = (By.ID,"com.byjus.thelearningapp:id/videoName")
    video_grades_elements = (By.ID,"com.byjus.thelearningapp:id/course_view_group")
    ham_bookmark=(By.XPATH,("//android.widget.TextView[@text='Bookmarks']"))
    video_title_on_player = (By.ID,"com.byjus.thelearningapp:id/tvVideoName")
    practice_back_arrow_btn = (By.ID,"com.byjus.thelearningapp:id/roundedNavButton")
    
#   VideoPlayer List Screen
    video_1st_list_lnk_text = (By.XPATH, "//androidx.recyclerview.widget.RecyclerView//android.widget.LinearLayout[@index = 0]//android.widget.TextView[@resource-id = 'com.byjus.thelearningapp:id/videoName']")
    video_list_lnk_xpath = (By.XPATH,"//androidx.recyclerview.widget.RecyclerView[@resource-id='com.byjus.thelearningapp:id/video_list_view' and @index=1]//android.widget.LinearLayout[@index=0]")    
    video_tab__sub_1st_video_lnk = (By.XPATH,"//android.widget.FrameLayout[@resource-id='com.byjus.thelearningapp:id/chapter_view_group' and @index = 1]")
    video_title_in_list_id = (By.ID, "com.byjus.thelearningapp:id/video_title_2")
    video_title = (By.ID, "com.byjus.thelearningapp:id/video_title_2")
    video_name_list = (By.XPATH,"//android.widget.TextView[@resource-id='com.byjus.thelearningapp:id/videoName']")
    video_auto_cancelBtn_id = (By.XPATH,"//android.widget.TextView[@text = 'Cancel']")
    video_tab_auto_cancel_btn = (By.ID,"com.byjus.thelearningapp:id/btnCancelAutoPlay")
    video_chapter_name_id = (By.ID,"com.byjus.thelearningapp:id/chapter_title_2")
    video_list_view_id = (By.ID,"com.byjus.thelearningapp:id/chapter_videos_lstvw")
    video_share_icon_id = (By.ID,"com.byjus.thelearningapp:id/ivShare")
    video_bookmark_icon_id = (By.ID,"com.byjus.thelearningapp:id/bookmark")
    video_topic_videos_id = (By.ID,"com.byjus.thelearningapp:id/videoName")
    video_progress_tab_id = (By.ID, "com.byjus.thelearningapp:id/exo_progress")
    video_tab_video_lst_1st_video = (By.XPATH,"//androidx.recyclerview.widget.RecyclerView[@resource-id='com.byjus.thelearningapp:id/video_list_view']//android.widget.LinearLayout[@index=0]")
    video_tab_video_lst_1st_video_title = (By.XPATH,"//androidx.recyclerview.widget.RecyclerView[@resource-id='com.byjus.thelearningapp:id/video_list_view']/android.widget.LinearLayout[@index=0]//android.widget.TextView[@index = 1]")
    video_tab_video_player_close_btn = (By.ID,"com.byjus.thelearningapp:id/video_list_close")
    video_player_list_lay = (By.ID,"com.byjus.thelearningapp:id/video_list_lay")
    video_grade_selection_btn = (By.ID, "com.byjus.thelearningapp:id/tvGrade")
    mob_video_title_on_player = (By.ID,"com.byjus.thelearningapp:id/videoTitle")
#     video Locator for tab  
    video_list_btn_tab = (By.ID, 'com.byjus.thelearningapp:id/video_list')
    video_list_close_btn_tab = (By.ID, 'com.byjus.thelearningapp:id/video_list_close')
    video_tab_videoframe = (By.ID,"com.byjus.thelearningapp:id/exo_subtitles")
    video_buffering =(By.ID, "com.byjus.thelearningapp:id/exo_buffering")
    video_badge_close_btn = (By.ID,"com.byjus.thelearningapp:id/ivCloseBtn")
    video_auto_enable_switch = (By.ID, "com.byjus.thelearningapp:id/swAutoplay")
    video_play_list_elements = (By.XPATH, "//android.widget.TextView[@resource-id='com.byjus.thelearningapp:id/videoName']")
    video_practice_lnk = (By.XPATH, "//android.widget.TextView[@text = 'Practice']")
    video_auto_play_btn =(By.ID,"com.byjus.thelearningapp:id/autoPlayProgressView")
    video_videos_list_in_video_list_lay_elements = (By.ID,"com.byjus.thelearningapp:id/videoItem")
    tab_videos_list_elements = (By.ID,"com.byjus.thelearningapp:id/videoItem") 
    test_page_id = (By.ID,"com.byjus.thelearningapp:id/chaptertest_recyclerview")
#     video Locators for tab
    video_frame_pause_btn = (By.ID,"com.byjus.thelearningapp:id/ivPlay")
    video_play_pause_btn = (By.XPATH,"//android.widget.LinearLayout[@resource-id='com.byjus.thelearningapp:id/center_area']//android.widget.ImageButton")
    video_10s_bckwrd_text = (By.XPATH,"//android.widget.LinearLayout[@resource-id='com.byjus.thelearningapp:id/center_area']//android.widget.FrameLayout[@resource-id='com.byjus.thelearningapp:id/exo_rew']//android.widget.TextView")
    video_10s_frwrd_text = (By.XPATH,"//android.widget.LinearLayout[@resource-id='com.byjus.thelearningapp:id/center_area']//android.widget.FrameLayout[@resource-id='com.byjus.thelearningapp:id/exo_ffwd']//android.widget.TextView")
    
#     Video Auto Enable 
    video_next_video_title = (By.XPATH,"//android.widget.LinearLayout[@resource-id = 'com.byjus.thelearningapp:id/llNextVideoInfo']/android.widget.TextView[@resource-id ='com.byjus.thelearningapp:id/tvNextVideoTitle']")
    tab_video_next_video_title = (By.ID,"com.byjus.thelearningapp:id/tvNextVideoTitle")
    video_next_video_chapter_name = (By.XPATH,"//android.widget.LinearLayout[@resource-id = 'com.byjus.thelearningapp:id/llNextVideoInfo']/android.widget.TextView[@resource-id = 'com.byjus.thelearningapp:id/tvChapterName']")
    video_tab_next_video_chapter_name = (By.ID,"com.byjus.thelearningapp:id/tvChapterName")
    video_up_next = (By.ID,"com.byjus.thelearningapp:id/tvUpNext")
    video_video_player_chapter_txt = (By.ID,"com.byjus.thelearningapp:id/tvNextVideoTitle")
    video_player_back_btn = (By.ID,"com.byjus.thelearningapp:id/back")
    video_tab_player_back_btn = (By.ID,"com.byjus.thelearningapp:id/backButton")
    video_analyze_icon_btn = (By.ID,"com.byjus.thelearningapp:id/home_analytics")
    video_keyFocus_1st_lnk = (By.XPATH,"//android.widget.RelativeLayout[@resource-id='com.byjus.thelearningapp:id/layout_keyfocusarea' and @index = 0]")
    ...
    video_test_lable = (By.XPATH,"//android.widget.TextView[@text = 'Test' and @resource-id = 'com.byjus.thelearningapp:id/primaryText']")
    video_practice_lable = (By.XPATH,"//android.widget.TextView[@text = 'Practice' and @resource-id = 'com.byjus.thelearningapp:id/primaryText']")
    video_test_x_test = (By.XPATH,"//android.widget.TextView[@text = 'Test']//parent::android.widget.RelativeLayout//android.widget.TextView[@resource-id ='com.byjus.thelearningapp:id/secondaryText']")
    video_practice_stage_name_test = (By.XPATH,"//android.widget.TextView[@text = 'Practice']//parent::android.widget.RelativeLayout//android.widget.TextView[@resource-id ='com.byjus.thelearningapp:id/secondaryText']")
    video_test_right_arrow = (By.XPATH,"//android.widget.TextView[@text = 'Test']//parent::android.widget.RelativeLayout//android.widget.ImageView[@resource-id ='com.byjus.thelearningapp:id/right_arrow']")
    video_practice_right_arrow = (By.XPATH,"//android.widget.TextView[@text = 'Practice']//parent::android.widget.RelativeLayout//android.widget.ImageView[@resource-id ='com.byjus.thelearningapp:id/right_arrow']")
    ...
    video_chapter_title_library_screen = (By.XPATH,"//android.widget.LinearLayout[@index = 1 and @resource-id = 'com.byjus.thelearningapp:id/chapter_view_group']//android.widget.TextView[@resource-id = 'com.byjus.thelearningapp:id/chapter_title_view']")
    ...
    chapterScreen_chapter_name = (By.XPATH,"//android.widget.LinearLayout[@resource-id='com.byjus.thelearningapp:id/llHeaderTextParent']//android.widget.TextView[@resource-id='com.byjus.thelearningapp:id/header_title_text']")
    video_playback_speed_dialog = (By.XPATH,"//android.widget.TextView[@text ='Playback Speed']")
    video_playback_speed_frame = (By.ID,"com.byjus.thelearningapp:id/design_bottom_sheet")
    ...
    def verify_to_login_page(self, browser):
        if CommonMethods.wait_for_element_visible(browser, self.allow_btn_id, 10):
            CommonMethods.accept_notification(browser, self.allow_btn_id)
            CommonMethods.accept_notification(browser, self.allow_btn_id)
#             ============================
...
#             ============================
            ...
            CommonMethods.wait_for_locator(browser, self.OtpTxtBx_id, 15)
            CommonMethods.enterText(browser, getdata(Login_Credentials, 'login_details', 'OTP'), self.OtpTxtBx_id)
        elif CommonMethods.wait_for_element_visible(browser, self.loginBtn_id, 10):
                CommonMethods.wait_for_locator(browser,self.country_Code,15)
                CommonMethods.elementClick(browser,self.country_Code)
                sleep(2)
                CommonMethods.scrollToElementAndClick(browser,getdata(Login_Credentials,'login_details'
    ...
    def verify_badge(self, browser):
        if CommonMethods.wait_for_element_visible(browser, self.video_badge_close_btn, 3):
    ...
    def navigate_to_home_screen(self, browser, text):
            try:
                ...
                if CommonMethods.wait_for_element_visible(browser, self.homescreen_corana_dialog, 7):
                    CommonMethods.elementClick(browser, self.homescreen_corana_dialog_ok_btn)
                    self.verify_home_page(browser)
                    VideoPage.subject_rgb_lst = self.get_the_rgb_lst(browser, subject_rgb)
                elif CommonMethods.wait_for_element_visible(browser, self.back_button_id, 7):
                    self.verify_badge(browser)
                    self.verify_home_page(browser)
                    VideoPage.subject_rgb_lst = self.get_the_rgb_lst(browser, subject_rgb)
                elif CommonMethods.wait_for_element_visible(browser, self.allow_btn_id, 5) or CommonMethods.wait_for_element_visible(browser, self.loginBtn_id, 5) :
    ...
    def verify_video_paused(self,browser):
        try:
            ...
            if device == 'tab':
                ...
                check1 = CommonMethods.isElementPresent(browser,self.video_play_btn)
                check2 = browser.find_element_by_xpath("//androidx.recyclerview.widget.RecyclerView[@resource-id='com.byjus.thelearningapp:id/video_list_view']/android.widget.LinearLayout[@index=0]//android.widget.TextView[@resource-id='com.byjus.thelearningapp:id/chapter_video_subitem_name_txtv']").text
                logging.info(check1)
                logging.info(check2)
    ...
    def navigateToLoginPage(self,browser):
        try: 
            if CommonMethods.wait_for_element_visible(browser, self.skipBtn_id, 2):
                browser.find_element_by_id("com.byjus.thelearningapp:id/buttonSkip").click()
                browser.find_element_by_xpath("//android.widget.Button[@text='8th']").click()
                browser.find_element_by_id("com.byjus.thelearningapp:id/tvLoginBl").click()
            else:
...
#                     pytest.fail("Failed due to Element not visible in Video Page")
    ...
    def verify_speed_down_compare_to_normal(self, browser):
        try:
            ...
            sleep(10)
            end_time = self.get_video_start_time(browser)
            check = (end_time - start_time) < 10 > 5 
...
#                     pytest.fail("Failed due to Element not visible in Video Page")
    ...
    def verify_video_screen(self, browser):
        try:
            self.pause_video(browser)
            check = CommonMethods.wait_for_element_visible(browser, self.video_frame_id, 3)
            self.verify_false(browser, check, 'verify_video_screen', 'video frame')
        except NoSuchElementException:
...
#             CommonMethods.exception(browser,featureFileName,'verify_video_in_potrait')
    ...
    def select_topic(self,browser,topic,chapter):
        try:
            ...
            sub_chapter_xpath = (By.XPATH,"//android.widget.LinearLayout[@resource-id='com.byjus.thelearningapp:id/chapter_view_group']//android.widget.RelativeLayout//android.widget.TextView[@text=\'"+chapter+"\']//parent::android.widget.RelativeLayout//following::androidx.recyclerview.widget.RecyclerView")
            video_count = (By.XPATH,"//android.widget.LinearLayout[@resource-id='com.byjus.thelearningapp:id/chapter_view_group']//android.widget.RelativeLayout//android.widget.TextView[@text=\'"+chapter+"\']//parent::android.widget.RelativeLayout//android.widget.TextView[@resource-id='com.byjus.thelearningapp:id/video_count']") 
    ...
    def verify_video_name(self,browser):
        try:
            ...
            video_title = "//android.widget.TextView[@resource-id='com.byjus.thelearningapp:id/videoName' and @text = \'"+video_title_name+"\']"
    ...
    def verify_video_thumbnail(self,browser):
        try:
            video_title_name = CommonMethods.getAttributeOfElement(browser,'text', self.video_title_in_list_id) 
            video_thumbnail = (By.XPATH,"//android.widget.TextView[@resource-id='com.byjus.thelearningapp:id/videoName' and @text =\'"+video_title_name+"\']//parent::android.widget.RelativeLayout//android.widget.ImageView[@resource-id='com.byjus.thelearningapp:id/thumbnail']")
    ...
    def verify_video_duration(self,browser):
        try:
            video_title_name = CommonMethods.getAttributeOfElement(browser,'text', self.video_title_in_list_id)
            sleep(2)
            video_title =(By.XPATH, "//androidx.recyclerview.widget.RecyclerView[@resource-id='com.byjus.thelearningapp:id/video_list_view']//android.widget.LinearLayout//android.widget.TextView[@text=\'"+video_title_name+"\']//parent::android.widget.RelativeLayout//android.widget.TextView[@resource-id='com.byjus.thelearningapp:id/chapter_video_subitem_name_txtv']")
    ...
    def verify_video_progress(self,browser):
        try:
            video_title_name = CommonMethods.getAttributeOfElement(browser,'text', self.video_title_in_list_id)
            video_progress =(By.XPATH, "//androidx.recyclerview.widget.RecyclerView[@resource-id='com.byjus.thelearningapp:id/video_list_view']//android.widget.LinearLayout//android.widget.TextView[@text=\'"+video_title_name+"\']//parent::android.widget.RelativeLayout//android.widget.ProgressBar")
    ...
    def verify_progression_100_percent(self, browser):
        try:
            ...
            if device == 'tab':
                video_title_name = CommonMethods.getAttributeOfElement(browser, 'text', self.video_title_on_player)
                sleep(2)
                progression_percent = (By.XPATH, "//androidx.recyclerview.widget.RecyclerView[@resource-id='com.byjus.thelearningapp:id/video_list_view']//android.widget.LinearLayout//android.widget.TextView[@text=\'" + video_title_name + "\']//parent::android.widget.RelativeLayout//android.widget.ProgressBar[@resource-id='com.byjus.thelearningapp:id/video_progress_view']")
...
#             window_height = CommonMethods.get_window_height(browser)
    ...
    def verify_chapter_name_color(self, browser):
        try:
            ...
            CommonMethods.noSuchEleExcept(browser, featureFileName, 'verify_chapter_name_color')

        except:
            CommonMethods.exception(browser, featureFileName, 'verify_chapter_name_color')
    ...
    def verify_chapter_name_color_with_subject_theme(self, browser):
        try:
            css_data = browser.find_element_by_id('com.byjus.thelearningapp:id/video_title_2').value_of_css_property("style")
...
#             self.tap_on_video_player_icon(browser, self.video_settingIcon_id)
    ...
    def verify_video_player_next_btn(self, browser):
        try:
            ...
            self.verify_false(browser, check, 'verify_video_player_next_btn', 'Next Btn')
        except NoSuchElementException:
    ...
    def complete_video(self, browser):
        try:
            ...
            self.end_the_video(browser)
            self.play_video(browser)
            check = CommonMethods.wait_for_element_visible(browser, self.video_play_btn, 60)
...
#                 video_title_previous = VideoPage.video_sub_title_name
    ...
    def verify_subtopic_video_slider(self, browser):
        try:
            check = CommonMethods.wait_for_element_visible(browser, self.video_player_list_lay, 5)
    ...
    def tap_on_cancel_button(self, browser):
        try:
            device = CommonMethods.get_device_type(browser)
            if device == 'mobile':
                CommonMethods.wait_for_element_visible(browser, self.video_auto_cancelBtn_id, 5)
                VideoPage.next_video_title = CommonMethods.getTextOfElement(browser, self.video_next_video_title)
    ...
    def verify_previous_icon_not_on_video(self, browser):
        try:
            check =  not  CommonMethods.isElementPresent(browser, self.video_play_previous_btn)
            self.verify_true_or_false(browser, check, 'verify_previous_icon_on_video', 'previous btn')
        except NoSuchElementException:
            CommonMethods.noSuchEleExcept(browser, featureFileName, 'verify_previous_icon_on_video')
    ...
    def tap_on_keyFocus_area(self, browser):
        try:
            ...
            check = CommonMethods.wait_for_element_visible(browser, self.video_keyFocus_1st_lnk, 5)
            if check == True:
...
#             logging.info("Error in ending the video")  
    ...
    def verify_comming_soon_on_video_card(self, browser, chapter):
        try:
            CommonMethods.scrollToElement(browser, chapter)
            comming_soon_locator = (By.XPATH,"//android.widget.TextView[@text=\'"+chapter+"\']//parent::android.widget.RelativeLayout//following-sibling::androidx.recyclerview.widget.RecyclerView//android.widget.TextView[@resource-id='com.byjus.thelearningapp:id/chapter_video_list_comingsoon_txtvw']")
...
#                 VideoPage.chapter_name = CommonMethods.getTextOfElement(browser, self.video_chapter_name_id)
    ...
    def navigate_to_test_screen(self, browser):
        try:
            ...
            test_btn = (By.XPATH,"//android.widget.TextView[@text = \'"+VideoPage.chapter_name+"\']//ancestor::android.widget.LinearLayout[@resource-id ='com.byjus.thelearningapp:id/chapter_view_group']//android.widget.Button[@text = 'Test']")
    ...
    def tap_on_practice_card2(self, browser, chapter):
        try:
            ...
            practice_btn = (By.XPATH,"//android.widget.TextView[@text = \'"+chapter+"\']//ancestor::android.widget.LinearLayout[@resource-id ='com.byjus.thelearningapp:id/chapter_view_group']//android.widget.Button[@text = 'Practice']")
