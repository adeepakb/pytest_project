...
#Test list screenlocators    
    ...
    objective_test_list_xpath=(By.XPATH,"//android.widget.LinearLayout[@index=1]//android.widget.TextView[@resource-id='com.byjus.thelearningapp.premium:id/chapter_tests_list_item_txtv_testname']")
   # objective_test=(By.XPATH,"//android.widget.TextView[@resource-id='com.byjus.thelearningapp.premium:id/chapter_tests_list_item_txtv_testname'][contains(@text,'Exemplar')]")
    ...
    subjective_test_list_xpath=(By.XPATH,"//android.widget.LinearLayout[@index=2]//android.widget.TextView[@resource-id='com.byjus.thelearningapp.premium:id/chapter_tests_list_item_txtv_testname']")
    ncert_exemplars=(By.XPATH,"//android.widget.TextView[@resource-id='com.byjus.thelearningapp.premium:id/chapter_tests_list_item_txtv_testname'][contains(@text,'Exemplar')]")
    ncert_exercises=(By.XPATH,"//android.widget.TextView[@resource-id='com.byjus.thelearningapp.premium:id/chapter_tests_list_item_txtv_testname'][contains(@text,'Exercise')]")
    learn_testcard=(By.XPATH,"//android.widget.TextView[@resource-id='com.byjus.thelearningapp.premium:id/tvSubtopicName'][@text='Tests']")
    test_list_scn=(By.XPATH,"//android.widget.TextView[@resource-id='com.byjus.thelearningapp.premium:id/header_subtitle1_text'][@text='Test']")
...
#Test question screen locators    
    ...
    question_one_id=(By.XPATH,"//android.widget.TextView[@resource-id='com.byjus.thelearningapp.premium:id/tvTabText'][@text='1']")
    bookmarkdot_question_one=(By.XPATH,"//android.widget.TextView[@resource-id='com.byjus.thelearningapp.premium:id/flagged'][@text='1']")
    total_questions= 0
    color1= set()
    color2= set()
    question= None
...
#             if CommonMethods.findText(browser, 'Test'):
    ...
    def verify_objective_test_instruction1(self,browser,text):
        try:
            to_find_text = re.compile(r'(.*) mark is awarded for correct attempts and (.*) marks for incorrect attempts.')
    ...
    def verify_instruction_icons(self,browser):
        try:
            ...
            icon=(By.XPATH,"//android.widget.TextView/following-sibling::android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[@index=0]")
    ...
    def navigate_to_objective_test_question_scn(self,browser):
        try:
            ...
            test_link1=(By.XPATH,"//android.widget.TextView[@resource-id='com.byjus.thelearningapp.premium:id/chapter_title_view' and @text=\'"+chapter+"\']/parent::android.widget.LinearLayout/following-sibling::android.widget.LinearLayout/android.widget.TextView[@text='Test']")
            test_link2=(By.XPATH,"//android.widget.TextView[@resource-id='com.byjus.thelearningapp.premium:id/chapter_title_view' and @text=\'"+chapter+"\']//ancestor::android.widget.LinearLayout[@resource-id='com.byjus.thelearningapp.premium:id/chapter_view_group']//android.widget.Button[@text='Test']")
            ...
            test_locator=(By.XPATH,"//android.widget.TextView[@resource-id='com.byjus.thelearningapp.premium:id/chapter_tests_list_item_txtv_testname'][contains(@text,\'"+test_name+"\')]")
...
#             question_number_id=(By.XPATH,"//android.widget.TextView[@resource-id='com.byjus.thelearningapp.premium:id/tvTabText'][@text=\'"+str(question_number)+"\']")
    ...
    def verify_multiple_choice_question(self,browser):
        try:
            ...
            while True:
                if CommonMethods.isElementPresent(browser,self.radio_button)== False and CommonMethods.isElementPresent(browser,self.edit_text)== False:
...
#This method will fetch a question and returns question        
    def get_question(self,browser):
        try:
            ...
            test_question=(By.XPATH,"//androidx.viewpager.widget.ViewPager//android.view.View[@resource-id='q']/android.view.View[@index=0]")
            count=0
            elements=[]
