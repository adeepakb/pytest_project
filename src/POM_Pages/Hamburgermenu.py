...
class Hamburger():
    ...
    ham_btn_id = (By.ID,"com.byjus.thelearningapp:id/backNav")
    ...
    prof_acc_det_id = (By.ID, "com.byjus.thelearningapp:id/account_details_title")
    prof_details_id = (By.ID, "com.byjus.thelearningapp:id/profile_details")
    bmark_xpath = (By.XPATH, "//android.widget.TextView[@text='Bookmarks']")
    Bookmark_page_id = (By.ID, "com.byjus.thelearningapp:id/header_title_text")
