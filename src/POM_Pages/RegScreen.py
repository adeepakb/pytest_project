...
class RegScreen():
        ...
        def allow_permissions(self,browser):
            try:
                ...
                elif self.find_os_version(browser)<'6':
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'allow_permissions')
                
            except:
                CommonMethods.exception(browser, featureFileName, 'allow_permissions')
                
                
        def deny_permissions(self,browser):
            try:
                if CommonMethods.isElementPresent(browser, self.denybutton):
                    CommonMethods.elementClick(browser, self.denybutton)
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'deny_permissions')
                
            except:
                CommonMethods.exception(browser, featureFileName, 'deny_permissions')
                

        def navigate_to_reg_screen(self,browser):
            try:
                sleep(2)
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'navigateToRegScreen')
                
            except:
                CommonMethods.exception(browser, featureFileName, 'navigateToRegScreen')
        ...
        def verify_greeting_text(self,browser):
            try:
                actual_text =CommonMethods.getAttributeOfElement(browser,'text', self.header_greeting_text)
        ...
        def verify_name_field(self,browser):
            self.verify_field(browser,self.nametextfield,'Name Field')
        ...
        def verfy_email_field(self,browser):
            self.verify_field(browser,self.emailtextfield,'Email ID field')
        
            
        def verfy_city_field(self,browser):
            self.verify_field(browser,self.emailtextfield,'The City / Nearest Location field')
        
            
        def email_field_is_empty(self,browser):
            try:
                actual_text =CommonMethods.getAttributeOfElement(browser,'text', self.emailtextfield)
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'email_field_is_empty')
                
            except:
                CommonMethods.exception(browser, featureFileName, 'email_field_is_empty')
                
                
        def city_field_is_empty(self,browser):
            try:
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'city_field_is_empty')
                
            except:
                CommonMethods.exception(browser, featureFileName, 'city_field_is_empty')
                
                
        def click_on_name_field(self,browser):
            try:
                CommonMethods.elementClick(browser, self.nametextfield)
        ...
        def enter_name(self,browser,Characters):
            try:
                check =Characters.isalpha() or ' ' in Characters
                if check == True:
                    CommonMethods.enterText(browser, Characters, self.nametextfield)
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'enter_name')
                
            except:
                CommonMethods.exception(browser, featureFileName, 'enter_name')
        ...
        def navigate_to_course_selection_screen(self,browser):
            self.navigate_to_screen(browser,'Choose',self.header_greeting_text)
            logging.info('User navigated to "CourseSelectionScreen"')
        
            
        def check_google_account(self,browser):
            check = self.verify_google_account(browser)
            if check == True:
...
#                 pytest.fail('Google account is not registered')
            #CommonMethods.terminate_settings(browser)
            browser.activate_app('com.byjus.thelearningapp')
        
        
        def google_account_not_added(self,browser):
            check = self.verify_google_account(browser)
            if check == False:
...
#                 pytest.fail('Google account is added in the device')
        ...
        def check_email_address(self,browser):
            try:
                CommonMethods.wait_for_locator(browser,self.emailtextfield, 10)
                check =CommonMethods.getAttributeOfElement(browser,'text', self.emailtextfield)
                if check != 'Email':
                    logging.info('Email field is auto filled')
                elif self.find_os_version(browser)>='8':
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'check_email_address')
                
            except:
                CommonMethods.exception(browser, featureFileName, 'check_email_address')

                
        def check_city(self,browser):
            try:
                actual_text =CommonMethods.getAttributeOfElement(browser,'text', self.citytextfield)
                check = CommonMethods.verifyTextMatch(actual_text, 'City / Nearest location')
                if check == True:
                    ...
                    if CommonMethods.isElementPresent(browser, self.location_ok):
                        ...
                        self.tap_on_location_icon(browser)
                    sleep(3)
                check =CommonMethods.getAttributeOfElement(browser,'text', self.citytextfield)
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'check_city')
                
            except:
                CommonMethods.exception(browser, featureFileName, 'check_city')
                               
                        
        def click_mobile_num_field(self,browser):
            try:
                CommonMethods.clearData(browser, self.phonetextfield)
                CommonMethods.elementClick(browser, self.phonetextfield)
        ...
        def enter_mobile_number(self,browser,phone_number): 
            try:
                ...
                if check == True: 
                    CommonMethods.enterText(browser,phone_number,self.phonetextfield)
        ...
        def tap_on_regbtn(self,browser):
            try:
                CommonMethods.elementClick(browser, self.btnRegister)  
            except NoSuchElementException:
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'tap_on_regbtn')
                
            except:
                CommonMethods.exception(browser, featureFileName, 'tap_on_regbtn')
                logging.error('Failed to tap on register button')  
         

         
        def name_field_toast_Msg(self,browser):
            try:
                CommonMethods.run('adb shell input touchscreen swipe 537 483 537 1000')
                CommonMethods.hideKeyboard(browser)
                CommonMethods.wait_for_locator(browser, self.nametextfield, 5)
                CommonMethods.elementClick(browser,self.nametextfield)
                CommonMethods.hideKeyboard(browser)
                self.extracting_text_from_image(browser,r'Please enter your name.','Please enter your name.')
                
            except NoSuchElementException:
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'name_field_toast_Msg')   
            

        def phonenumber_field_errormessage(self,browser):
            try:
        ...
        def verify_city_toastmsg(self,browser):
            try:
                CommonMethods.wait_for_locator(browser, self.citytextfield, 5)
                CommonMethods.elementClick(browser,self.citytextfield)
                CommonMethods.hideKeyboard(browser)
                self.extracting_text_from_image(browser,r'Please enter your city','Please enter your city')

            except NoSuchElementException:
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'verify_city_toastmsg')    
             
            except:
                CommonMethods.exception(browser, featureFileName, 'verify_city_toastmsg')

         
        def emailfield_toastmsg_verification(self,browser):
            try:
                CommonMethods.wait_for_locator(browser, self.emailtextfield, 5)
                CommonMethods.elementClick(browser,self.emailtextfield)
                CommonMethods.hideKeyboard(browser)
                self.extracting_text_from_image(browser,r'Please enter your email address','Please enter your email address')
                 
            except NoSuchElementException:
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'emailfield_toastmsg_verification')    
             
            except:
                CommonMethods.exception(browser, featureFileName, 'emailfield_toastmsg_verification')
                
                
        def country_code_dropdown(self,browser):
            try:
                CommonMethods.isElementPresent(browser, self.countrycodedrop_down)
                actual_text =CommonMethods.getAttributeOfElement(browser,'text', self.countrycodedrop_down_text_view)
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'country_code_dropdown')    
             
            except:
                CommonMethods.exception(browser, featureFileName, 'country_code_dropdown')
        
                
        def country_code_dropdown_click(self,browser):
            try:
                CommonMethods.wait_for_locator(browser, self.countrycodedrop_down, 10)
        ...
        def select_country_code(self,browser,CountryName,CountryCode):
            try:
                CommonMethods.elementClick(browser,(By.XPATH,"//*[contains(@text, \'"+CountryName+"\')]"))                             
                CommonMethods.wait_for_locator(browser, self.countrycodedrop_down_text_view,10)
        ...
        def get_country_list_and_verify(self,browser):
            try:
                count = 0
                previous_text = str()
                country_list =[]
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'get_country_list_and_verify')    
             
            except:
                CommonMethods.exception(browser, featureFileName, 'get_country_list_and_verify')
                logging.error('Failed to verify the country list')       
            
            
        def verify_phonenumber_valid_error_msg(self,browser,phone_number):
            try:
                actual_num = CommonMethods.getAttributeOfElement(browser,'text', self.phonetextfield)
                if len(actual_num)>15 or len(actual_num)<7:
                    if CommonMethods.isElementPresent(browser, self.PhoneErrorMsg):
                        errorMessage= CommonMethods.getAttributeOfElement(browser,'text', self.PhoneErrorMsg)
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'verify_phonenumber_valid_error_msg')    
             
            except:
                CommonMethods.exception(browser, featureFileName, 'verify_phonenumber_valid_error_msg')
                logging.error('"Please enter a valid mobile number" error message is not shown')              
                

                
        def enter_emailaddress(self,browser,EmailId):
            try:
                CommonMethods.enterText(browser, EmailId,self.emailtextfield)
                
            except NoSuchElementException:
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'enter_emailaddress')    
             
            except:
                CommonMethods.exception(browser, featureFileName, 'enter_emailaddress')
                logging.error('Failed to enter email address')    
        
                       
        def verify_invalid_emailid_toastmsg(self,browser):
            try:
                CommonMethods.elementClick(browser,self.emailtextfield)
                CommonMethods.hideKeyboard(browser)
                sleep(3)
                self.extracting_text_from_image(browser,r'Please enter (.*)','Please enter valid email address')
    
            except NoSuchElementException:
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'verify_invalid_emailid_toastmsg')    
             
            except:
                CommonMethods.exception(browser, featureFileName, 'verify_invalid_emailid_toastmsg')
        ...
        def navigate_back_reg_scrn(self,browser): 
            try:
                self.navigate_to_screen(browser,'5000+ Engaging Videos',self.header_title_text)
                logging.info('User is in registration screen')
        ...
        def extracting_text_from_image(self,browser,rtext,expected):
            sleep(3)
            open_image = Image.open(self.screenshot(browser))
        ...
        def scroll_list(self,browser,textlist):
            ...
            box_list =browser.find_element_by_xpath("//android.widget.ListView")
        ...
        def find_os_version(self,browser):
        ...
        def verify_google_account(self,browser):
            browser.start_activity('com.android.settings', 'com.android.settings.Settings')
            CommonMethods.scrollToElement(browser, 'Google')
            CommonMethods.elementClick(browser,(By.XPATH,"//android.widget.TextView[@text='Google']"))
            if CommonMethods.findButton(browser, 'Sign in to your Google Account'):
                logging.info('Google account is not added')
                self.google_account = False
            elif CommonMethods.findButton(browser,'Manage your Google Account'):
                CommonMethods.elementClick(By.ID,"com.google.android.gms:id/account_spinner")
                sleep(3)
                list1 = []
                acc = browser.find_elements_by_xpath("//*[contains(@text, '.com')]")
        ...
        def device_gps_location(self,browser):
            try:
                lat_la = browser.location
                ...
                return self.device_gps_location(browser)
        
                  
        def verify_current_location(self,browser):
            sleep(2)
            app_location=CommonMethods.getAttributeOfElement(browser, 'text', self.citytextfield)
            device_location = self.device_gps_location(browser)
            ...
            try:
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'verify_current_location')    

            except:
                CommonMethods.exception(browser, featureFileName, 'verify_current_location')
         
                
        def tap_on_locationfield(self,browser):
            try:
                CommonMethods.elementClick(browser, self.citytextfield)
                logging.info('User tapped on location field')
            
            except NoSuchElementException:
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'tap_on_locationfield')    

            except:
                CommonMethods.exception(browser, featureFileName, 'tap_on_locationfield') 
        
               
        def enter_location_manually(self,browser,Location):
            try:
                if CommonMethods.enterText(browser, Location, self.citytextfield):
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'enter_location_manually')    

            except:
                CommonMethods.exception(browser, featureFileName, 'enter_location_manually')
        
            
        def tap_on_allow_button(self,browser): 
            try:
                CommonMethods.elementClick(browser, self.allowbutton) 
            
            except NoSuchElementException:
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'tap_on_allow_button')    

            except:
                CommonMethods.exception(browser, featureFileName, 'tap_on_allow_button')
        
                
        def verify_location_permission(self,browser):
            try:
                if CommonMethods.isElementPresent(browser,self.allowbutton):
                    actualText= CommonMethods.getAttributeOfElement(browser, 'text', self.permission_message)
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'verify_location_permission')    

            except:
                CommonMethods.exception(browser, featureFileName, 'verify_location_permission')    
        ...
        def tap_on_location_icon(self,browser):
            try:
                self.tap_on_location_icon1(browser)
                if CommonMethods.isElementPresent(browser, self.location_ok):
                    CommonMethods.elementClick(browser, self.location_ok)
                    self.tap_on_location_icon1(browser)
                sleep(3)
        ...
        def tap_on_deny_button(self,browser): 
            try:
                CommonMethods.elementClick(browser, self.denybutton)
                if CommonMethods.isElementPresent(browser, self.secondaryActionBtn):
                    CommonMethods.elementClick(browser, self.secondaryActionBtn) 
                
            except NoSuchElementException:
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'tap_on_deny_button')    

            except:
                CommonMethods.exception(browser, featureFileName, 'tap_on_deny_button')

               
        def select_grade(self,browser):
            try:
                CommonMethods.isElementPresent(browser,self.grade8th)
                CommonMethods.elementClick(browser,self.grade8th)
                if CommonMethods.isElementPresent(browser, self.gms_cancel):
                    CommonMethods.elementClick(browser,self.gms_cancel)
            
            except NoSuchElementException:
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'select_grade')    

            except:
                CommonMethods.exception(browser, featureFileName, 'select_grade')
                
                
        def bottom_sheet_dialog_shown(self,browser):

            check = CommonMethods.isElementPresent(browser, self.dialogBox_msg)
            if check == True:
        ...
        def check_phone_number(self,browser,phone_number):
            try:    
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'check_phone_number')
                
            except:
                CommonMethods.exception(browser, featureFileName, 'check_phone_number')
        
        def navigate_to_otp_verification_scn(self,browser):
            try:
                self.navigate_to_screen(browser,'To complete registration',self.header_subtitle_text)
                logging.info('User navigated to "OTP verification Screen"') 
            except NoSuchElementException:
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'navigate_to_otp_verification_scn')
                
            except:
                CommonMethods.exception(browser, featureFileName, 'navigate_to_otp_verification_scn')    

                
        def launch_app(self,browser):
            try:
                sleep(5)
                self.tap_device_backbtn(browser)
                self.tap_device_backbtn(browser)

            except:
                CommonMethods.exception(browser, featureFileName, 'launch_app')
                
                
        def allow_location_settings_permission(self,browser):
            try:
                CommonMethods.elementClick(browser,(By.XPATH,"//android.widget.TextView[@text='Permissions']"))
                CommonMethods.elementClick(browser,(By.XPATH,"//android.widget.TextView[@text='Location']"))
               
            except NoSuchElementException:
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'allow_location_settings_permission')    
             
            except:
                CommonMethods.exception(browser, featureFileName, 'allow_location_settings_permission')
        
        
        def hint_dialog_shown(self,browser):
            try:
                Check1 =CommonMethods.isElementPresent(browser, self.gms_cancel)
                Check2=CommonMethods.isElementPresent(browser,self.email_xpath)
                if Check1 == True and Check2 ==False:
                    logging.info('Phone number Hint requset pop up is shown')
                elif Check2 ==True and  Check1== True:
                    if CommonMethods.isElementPresent(browser, self.gms_cancel):
                        CommonMethods.elementClick(browser, self.gms_cancel)
                    CommonMethods.wait_for_locator(browser,self.regscn_lgnbtn, 10)
                    CommonMethods.elementClick(browser,self.regscn_lgnbtn)
                    CommonMethods.wait_for_locator(browser, self.loginRegBtn, 10)
                    CommonMethods.enterText(browser, '',self.phonetextfield)
                    CommonMethods.elementClick(browser,self.loginRegBtn)
                    CommonMethods.wait_for_locator(browser, self.grade8th,10)
                    CommonMethods.elementClick(browser,self.grade8th)
                    sleep(2)
                    if CommonMethods.isElementPresent(browser, self.gms_cancel):
                        logging.info('Hint requset pop up is shown')
                elif self.verify_google_account(browser)==False:
                    browser.activate_app('com.byjus.thelearningapp')
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'hint_dialog_shown')    
             
            except:
                CommonMethods.exception(browser, featureFileName, 'hint_dialog_shown')
                
        def hint_dialog_shown_mail(self,browser):
            try:
                Check =CommonMethods.isElementPresent(browser, self.gms_cancel)
                if Check == True:
                    CommonMethods.isElementPresent(browser,self.email_xpath)
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'hint_dialog_shown_mail')    
             
            except:
                CommonMethods.exception(browser, featureFileName, 'hint_dialog_shown_mail')

        def hint_dialog_notshown(self,browser):
            try:
                if CommonMethods.isElementPresent(browser, self.gms_cancel):
                    logging.error('Hint request pop up is shown since the device email id is registered with other application')
                
                elif self.verify_google_account(browser)==True:
                    browser.activate_app('com.byjus.thelearningapp')
...
#                     pytest.fail('Hint request pop up is shown')  
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'hint_dialog_notshown')    
             
            except:
                CommonMethods.exception(browser, featureFileName, 'hint_dialog_notshown')
                    
        
        def select_phonenumber_from_hint_dialog(self,browser):
            try:
                if self.hint_dialog ==False:
                    logging.info('Hint dialog not shown')
                else:
                    ele =CommonMethods.getElements(browser, self.hint_element_list)
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'Tap_number_hint_dialog')    
             
            except:
                CommonMethods.exception(browser, featureFileName, 'Tap_number_hint_dialog')
                
        
        def verify_mobileno_from_hint(self,browser):
            try:
                if self.hint_dialog ==False:
                    logging.info('Hint dialog not shown')
                else:
                    mobile_number = CommonMethods.getAttributeOfElement(browser, 'text',self.phonetextfield)
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'verify_mobileno_from_hint')    
             
            except:
                CommonMethods.exception(browser, featureFileName, 'verify_mobileno_from_hint')
        
                
        def verify_email_from_hint(self,browser):
            try:
                if self.hint_dialog ==False:
                    logging.info('Hint dialog not shown')
                else:
                    email = CommonMethods.getAttributeOfElement(browser, 'text',self.emailtextfield)
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'verify_email_from_hint')    
             
            except:
                CommonMethods.exception(browser, featureFileName, 'verify_email_from_hint')        
        
        
        def navigate_reg_for_hint_dialog(self,browser):
            try:
                if CommonMethods.isElementPresent(browser,self.skipButton):
                    logging.info('User is in onboarding screen')
                    CommonMethods.elementClick(browser, self.skipButton)
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'navigate_reg_for_hint_dialog')    
             
            except:
                CommonMethods.exception(browser, featureFileName, 'navigate_reg_for_hint_dialog')
        
                
        def select_emailfrom_hint_dialog(self,browser):
            try:
                if self.hint_dialog ==False:
                    logging.info('Hint dialog not shown')
                else:
                    ele =CommonMethods.getElements(browser, self.hint_element_list)
                    email1 =browser.find_elements_by_xpath("//*[contains(@text, '.com')]")
                    self.email =email1[0].get_attribute('text')
                    ele[0].click()
            except NoSuchElementException:
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'select_emailfrom_hint_dialog')    
             
            except:
                CommonMethods.exception(browser, featureFileName, 'select_emailfrom_hint_dialog')
        
        
        def tap_on_deny_button_loc(self,browser): 
            try:
                CommonMethods.elementClick(browser, self.denybutton)
            except NoSuchElementException:
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'tap_on_deny_button_loc')    
             
            except:
                CommonMethods.exception(browser, featureFileName, 'tap_on_deny_button_loc') 
                
                
        def enter_user_phone_email_name(self,browser):
            try:
                ...
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'enter_user_phone_email_name')    
             
            except:
                CommonMethods.exception(browser, featureFileName, 'enter_user_phone_email_name') 
                
        def enter_city_phone_name(self,browser):
            try:
                CommonMethods.enterText(browser,getdata(data_file, 'user_details', 'name'), self.nametextfield)
                CommonMethods.enterText(browser,getdata(data_file, 'user_details', 'mobile'), self.phonetextfield)
                CommonMethods.enterText(browser,getdata(data_file, 'user_details', 'city'), self.citytextfield)
            except NoSuchElementException:
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'enter_city_phone_name')    
             
            except:
                CommonMethods.exception(browser, featureFileName, 'enter_city_phone_name')    
        
        def enter_email_name(self,browser):
            try:
                CommonMethods.enterText(browser,getdata(data_file, 'user_details', 'name'), self.nametextfield)
                CommonMethods.enterText(browser,getdata(data_file, 'user_details', 'email'), self.emailtextfield)
            except NoSuchElementException:
                CommonMethods.noSuchEleExcept(browser, featureFileName, 'enter_email_name')    
             
            except:
                CommonMethods.exception(browser, featureFileName, 'enter_email_name')     
