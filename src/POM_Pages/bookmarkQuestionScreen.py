    ...
    def navigate_to_test(self,browser):
        try:
            ...
            if CommonMethods.isElementPresent(browser,self.start_btn):
                ...
                logging.info('User is in text list screen')
...
#This method is used to verify removed instruction in test instruction screen
    def istruction_notfound(self,browser,text):
        try:
            CommonMethods.wait_for_locator(browser,self.instruction_text, 10)
            actual_text =CommonMethods.getAttributeOfElement(browser,'content-desc',self.instruction_text)
            if actual_text!=text:
            ...
            CommonMethods.noSuchEleExcept(browser,featureFileName,'istruction_notfound')
...
#This method is used to verify instruction in test instruction screen
    def istruction_found(self,browser,text):
        try:
            ...
            CommonMethods.noSuchEleExcept(browser,featureFileName,'istruction_found')
...
#This method is used to bookmark question in test screen           
    def book_mark_a_question(self,browser):
        try:
            ...
            sleep(2)
#             CommonMethods.wait_for_element_visible(browser, self.toast_msg, 10)
...
#This method is used to bookmark in practice question screen            
    def bookmark_practice_qn(self,browser): 
        try:
            CommonMethods.wait_for_locator(browser, self.practice_bookmark, 20)
 ...
 #This method will fetch a question and returns question        
    def get_question(self,browser):
        try:
            count=0
            elements=[]
            elements=browser.find_elements_by_xpath("//android.view.View[@index='0']")
...
#This method is used to tap on undo option            
    ...
    def verify_bookmarkicon_with_subject_theme_color(self, browser):
        self.verify_subject_chapter_color(BookMarkQuestionScreen.subject_color, BookMarkQuestionScreen.bookmark_icon_color, 5)
