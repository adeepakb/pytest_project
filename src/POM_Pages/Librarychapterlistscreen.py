...
class LibraryChapterListsScreen():
    ...
    btn_back_arrow = (By.XPATH, "(//android.widget.Button[@resource-id='com.byjus.thelearningapp:id/roundedNavButton'])[1]")
    txt_greeting_text = (By.ID, "com.byjus.thelearningapp:id/header_greeting_text")
    btn_practice = (By.ID, "com.byjus.thelearningapp:id/practice_mode_bottom_txtvw")
    txt_practice_in_practice_screen = (By.ID, "com.byjus.thelearningapp:id/header_subtitle1_text")
    btn_test = (By.ID, "com.byjus.thelearningapp:id/chapter_list_item_test_txtvw")
    txt_test_in_test_screen = (By.ID, "com.byjus.thelearningapp:id/header_subtitle1_text")
    video_cards = (By.XPATH, "//android.widget.ImageView[@resource-id='com.byjus.thelearningapp:id/chapter_list_video_color_imgvw']")
    video_id_in_video_screen = (By.ID, "com.byjus.thelearningapp:id/exo_subtitles")
    chapter_names = (By.XPATH, "//android.widget.LinearLayout/descendant::android.widget.TextView[@resource-id='com.byjus.thelearningapp:id/chapter_title_view']")
    video_title_in_video_screen = (By.ID, "com.byjus.thelearningapp:id/chapter_title_2")
    video_count = (By.XPATH, "//android.widget.TextView[@resource-id='com.byjus.thelearningapp:id/video_count']")
#     chapterCountOfParticularChapterName=//android.widget.LinearLayout/descendant::android.widget.TextView[@text='Rational Numbers']/following-sibling::android.widget.TextView[@resource-id='com.byjus.thelearningapp:id/video_count']
    total_chapters = (By.ID, "com.byjus.thelearningapp:id/header_subtitle_text")
    video_thumbnail = (By.XPATH, "//android.widget.LinearLayout/android.widget.TextView[@resource-id='com.byjus.thelearningapp:id/chapter_video_list_video_name_txtvw']")
    video_progression_bar = (By.XPATH, "//android.widget.LinearLayout/descendant::android.widget.ProgressBar[@resource-id='com.byjus.thelearningapp:id/chapter_video_progress_view']")
    txt_chapters = (By.ID, "com.byjus.thelearningapp:id/chapterlistTitle")
    btn_optional_nav = (By.ID, "com.byjus.thelearningapp:id/optionalNav")
