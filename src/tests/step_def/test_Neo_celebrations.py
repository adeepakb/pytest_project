...
def login_as_neo_user(student1_login):
    student1_login.login_for_neo_class_mobile('+91-', '2016795330', otp=None)
...
def join_a_neo_session(student1_neo):
    # student1_neo.switch_to_alt_window('window_before')
...
def step_impl(student1_neo):
    ...
    ele_count2 = student1_neo.get_the_no_of_elements()
...
def step_impl(student1_neo):
    student1_neo.wait_until_enabled()
...
def step_impl(student1_neo):
    student1_neo.switch_to_alt_window()
    details = student1_neo.is_floating_emojis_present()
    check.equal(details.result, False, details.reason)
