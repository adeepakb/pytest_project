...
Scenario: Verify that see all CTA should be displayed when masterclass is booked
	Given launch the app and navigate to home screen
	And navigate to one to mega home screen
	When Verify all master classes are booked
	Then Verify  that see all CTA should be displayed
