...
Scenario: Verify that taping on app/device back navigation icon should land back on live classes home screen.
	Given Launch the app online
	When Click on the Premium school card in the home page
	And navigate to one to mega homescreen
	Then Tap on device/app back button
	And Verify that user navigates to "Live Classes" screen
