...
class NeoInClass(CommonMethodsWeb):
    ...
    def click_on_exit_class_in_student(self):
        if self.is_exit_class_btn_present():
        ...
        elif not self.is_exit_class_btn_present():
    ...
    def click_on_kebab_menu(self):
        time.sleep(3)
        if not self.is_exit_class_btn_present():
    ...
    def click_on_close_icon_in_toast_msg(self):
        ...
        flag = self.obj.wait_for_element_visible(('xpath',self.close_icon_toast_msg))
        if flag:
    ...
    def verify_class_started_message(self):
        try:
            ...
            return ReturnType(False, "Class started message is not displayed")
