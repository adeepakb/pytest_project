...
WebDriverInstance = TypeVar('WebDriverInstance', bound=WebDriver)
...
class TutorCommonMethods:
    ...
    def get_element(self, l_type: Text, l_value: Text, wait: bool=...) -> WebElement: ...
    ...
    @staticmethod
    def child_element_by_id(element: WebElement, id_locator_value: str) -> WebElement: ...

    @staticmethod
    def child_element_click_by_id(element: WebElement, id_locator_value: str) -> None: ...

    @staticmethod
    def child_element_text(element: WebElement, id_locator_value: str) -> str: ...

    @staticmethod
    def child_element_displayed(element:WebElement, id_locator_value: str) -> bool: ...
    ...
    def is_button_displayed_with_text(self, text: Text) -> bool: ...
    ...
    def verify_element_color(
            self, l_type: Optional[Text]=None, l_value: Optional[Text]=None,
            rgb_color_code: Union[Text, Tuple, List]=None, index: int=None, element: Optional[WebElement]=None) -> Text: ...
    ...
    def get_all_colors_present(
            self, l_type: Optional[Text]=None, l_value: Optional[Text]=None,
            element: Optional[WebElement]=None) -> Optional[List[Tuple[int, Any]]]: ...
    ...
    def get_working_days(self, day:float) -> List[datetime]: ...

    @staticmethod
    def compare_images(image1:Text, image2:Text) -> Any: ...

    def takeScreenShot(self, featureFileName:Text)  -> Any: ...

    def noSuchEleExcept(self, featureFileName:Text, methodName:Text) -> Any: ...

    def exception(self, featureFileName:Text, methodName: Text) -> Any: ...
